                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-7 col-lg-5 col-xl-5 col-xxl-4">
                            <div class="nk-block">
                                ...
                                <?php
                                // Získání tokenu z URL a jeho uchování pro odeslání formuláře
                                ...
                                <div class="text-center mt-3">
                                    <p class="small">
                                        ...
                                        ?>
                                        <a href="<?php echo $loginUrl; ?>">Return to Login</a>
                                    </p>
                                </div>
                ...
                <div class="nk-footer">
                    <div class="container-xl">
                        <div class="d-flex align-items-center flex-wrap justify-content-between mx-n3">
                            ...
                            <div class="nk-footer-copyright fs-6 px-3"> &copy; 2023 Copygen. </div>
                        </div>
                    </div>
                </div>
